...
namespace MusicStoreMVC.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public ArtistController(MusicStoreMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artists != null ? 
                          ...
                          Problem("Entity set 'MusicStoreMVCContext.Artists'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ArtistId,Name")] Artist artist)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'MusicStoreMVCContext.Artists'  is null.");
            }
            var artist = await _context.Artists.FindAsync(id);
            if (artist != null)
            {
